...
SET TARGET_DIR=%RIMWORLD_DIR_STEAM%\Mods
SET TARGET_DEBUG_DIR=%RIMWORLD_DIR_STANDALONE%\Mods
SET ZIP_EXE="C:\Program Files\7-Zip\7z.exe"

SET HARMONY_PATH=%SOLUTION_DIR%\v1.3\Assemblies\0Harmony.dll
SET MOD_DLL_PATH=%SOLUTION_DIR%\v1.3\Assemblies\%~3.dll
